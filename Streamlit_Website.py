...
# Function to display the video page with a button
def display_video_page():
    ...
    # Content on the video page
    st.markdown("<div class='content'>", unsafe_allow_html=True)
    st.markdown("<h1>Football Data Analysis</h1>", unsafe_allow_html=True)
    st.markdown("<p>Welcome to the football analysis page!</p>", unsafe_allow_html=True)
...
# Add navigation to go to the video page
if st.session_state.page == "Home":
    if st.button("Go to Video Page"):
